...
------------------------------------------------
-- XYRIX MINI BUTTON (FULL VERSION)
------------------------------------------------
...
miniButton.TextColor3 = Color3.fromRGB(255,90,90)
...
textStroke.Parent = miniButton
textStroke.Color = Color3.fromRGB(120,0,0)
...
------------------------------------------------
-- DRAG SYSTEM for mobile i think
------------------------------------------------
...
-- Create GUI
local gui = Instance.new("ScreenGui")
gui.Name = "StealingProgressGUI"
gui.ResetOnSpawn = false
gui.Parent = player:WaitForChild("PlayerGui")
gui.Enabled = false

local barFrame = Instance.new("Frame", gui)
barFrame.Size = UDim2.new(0, 300, 0, 25)
barFrame.Position = UDim2.new(0.5, -150, 0, 20)
...
local label = Instance.new("TextLabel", barFrame)
label.Size = UDim2.new(1,0,1,0)
label.BackgroundTransparency = 1
label.TextColor3 = Color3.fromRGB(255,255,255)
label.Font = Enum.Font.GothamBold
label.TextScaled = true
label.Text = "Stealing Progress"

-- Help tab button
local helpTab = contents[4] -- change to your actual Help tab
local button = Instance.new("TextButton", helpTab)
button.Size = UDim2.new(1,-20,0,50)
button.Position = UDim2.new(0,10,0,helpTab.AbsoluteSize.Y-60)
button.BackgroundColor3 = Color3.fromRGB(35,35,35)
button.TextColor3 = Color3.fromRGB(255,255,255)
button.Font = Enum.Font.GothamBold
button.TextScaled = true
button.Text = "Toggle Steal BrainRot"
Instance.new("UICorner", button).CornerRadius = UDim.new(0,12)

button.MouseButton1Click:Connect(function()
	stealingEnabled = not stealingEnabled
	gui.Enabled = stealingEnabled
	button.BackgroundColor3 = stealingEnabled and Color3.fromRGB(200,0,0) or Color3.fromRGB(35,35,35)
end)
...
RunService.RenderStepped:Connect(function(dt)
	...
	for _, v in pairs(workspace:GetChildren()) do
		if v.Name:lower():find("brain") and v:IsA("Model") then
			local part = v:FindFirstChild("Handle") or v:FindFirstChildWhichIsA("BasePart")
			if part then
	...
	-- Only fill if holding E and near brain
	if UIS:IsKeyDown(Enum.KeyCode.E) and targetBrain then
		holdProgress = math.clamp(holdProgress + dt*0.5, 0, 1)
	else
		holdProgress = math.clamp(holdProgress - dt*0.3, 0, 1)
	end

	fill.Size = UDim2.new(holdProgress,0,1,0)

	if holdProgress >= 1 and targetBrain then
		targetBrain.CFrame = hrp.CFrame * CFrame.new(0,2,0)
		targetBrain.Parent = char
		holdProgress = 0
	end
end)